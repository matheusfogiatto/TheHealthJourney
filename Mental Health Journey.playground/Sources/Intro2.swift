...
public class Intro2: SKScene {
    ...
    override public func didMove(to view: SKView) {
        ...
        label!.text =
        """
        Mental health includes our emotional, psychological, and social well-being. It affects how we think, feel, and act. It also helps determine how we handle stress, relate to others, and make choices. Next, I prepared some exercises that can contribute to better mental health. Let’s try?
        """

...
public class BreathingGame: SKScene {
    ...
    override public func didMove(to view: SKView) {
        ...
        """
        Place one hand on your belly and breathe with the shape
        """
...
//        resizeAndRotate(widthQuantity: 2.1, angleQuantity: 0.39, duration: timeInterval, node: star11)
    ...
    func buildStar(){
        star = SKSpriteNode()
        star = SKSpriteNode(imageNamed: "BreathingGame/yellowStar")
    ...
    func buildStar2(){
        star2 = SKSpriteNode()
        star2 = SKSpriteNode(imageNamed: "BreathingGame/pinkStar")
    ...
    func buildStar3(){
        star3 = SKSpriteNode()
        star3 = SKSpriteNode(imageNamed: "BreathingGame/greenStar")
    ...
    func buildStar4(){
        star4 = SKSpriteNode()
        star4 = SKSpriteNode(imageNamed: "BreathingGame/blueStar")
    ...
    func buildStar5(){
        star5 = SKSpriteNode()
        star5 = SKSpriteNode(imageNamed: "BreathingGame/purpleStar")
    ...
    func buildStar6(){
        star6 = SKSpriteNode()
        star6 = SKSpriteNode(imageNamed: "BreathingGame/yellowStar")
    ...
    func buildStar7(){
        star7 = SKSpriteNode()
        star7 = SKSpriteNode(imageNamed: "BreathingGame/pinkStar")
    ...
    func buildStar8(){
        star8 = SKSpriteNode()
        star8 = SKSpriteNode(imageNamed: "BreathingGame/greenStar")
    ...
    func buildStar9(){
        star9 = SKSpriteNode()
        star9 = SKSpriteNode(imageNamed: "BreathingGame/blueStar")
    ...
    func buildStar10(){
        star10 = SKSpriteNode()
        star10 = SKSpriteNode(imageNamed: "BreathingGame/purpleStar")
    ...
    override public func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        if first{
            ...
            Timer.scheduledTimer(timeInterval: 24, target: self, selector: #selector(canCountinue), userInfo: nil, repeats: false)
        }else if canContinue{
